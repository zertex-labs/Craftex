        ...
        {providers.map((provider) => {
          ...
          return (
            <button
              ...
              className="px-8 py-2 disabled:opacity-50 transition duration-150 border-2 border-sky-400/40 bg-gray-400/5 hover:bg-sky-800/20 hover:border-sky-400 first:rounded-l-lg last:rounded-r-lg"
              key={provider}
